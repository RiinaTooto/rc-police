...
function notification(title, text, time, type)
    TriggerEvent('okokNotify:Alert', title, text, time/1000, type)
end
...
function ProgressBarFunction(time, text)
    ...
    elseif Config.ProgressBar:lower() == 'progressbars' then --LINK: https://github.com/EthanPeacock/progressBars/releases/tag/1.0
