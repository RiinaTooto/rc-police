Config = {
    ...
    ProgressBar = 'ox_lib', -- 'ox_lib' / 'progressBars' / 'pogressBar' / 'mythic_progbar' // Custom can be add in the cl_utils.lua!!!
    Inventory = 'ox_inventory', -- 'ox_inventory' / 'qb_inventory' / 'quasar_inventory' / 'chezza_inventory' // Custom can be add in the cl_utils.lua!!!
    Metric = 'kmh', -- 'kmh' / 'mph'
    BrutalNotify = false, -- Using okokNotify instead
    ...
    PoliceStations = {
        ...
        ['Police Department'] = {
            ...
            Duty = vector3(-597.362610, -417.810974, 35.16), -- Duty ON / OFF coords
            DutyBlips = true, -- With this the cops can see the other cops in the map.

            Cloakrooms = {
                vector3(-602.597778, -421.252746, 35.16),
            },

            Armorys = {
                vector3(-608.307678, -413.393402, 35.16),
            },
            ...
            Garages = {
                {
                    ...
                    menu = vector3(-594.263732, -428.268128, 31.15), -- Garage menu open coords
                    spawn = vector4(-594.751648, -424.641754, 30.594116, 269.29), -- Vehicle spawn coords
                    deposit = vector3(-594.751648, -424.641754, 30.59), -- Vehicle deposit place
...

                {
                    ...
                    menu = vector3(-592.905518, -420.435150, 49.53),
                    spawn = vector4(-596.043946, -431.327484, 51.369996, 181.41),
                    deposit = vector3(-596.043946, -431.327484, 51.36),
